    ...
    <footer id="footer" className="bg-emerald-deep text-stone py-12 px-12 border-t-[12px] border-emerald-deep">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="text-[10px] uppercase tracking-[0.2em] opacity-60">
          &copy; {new Date().getFullYear()} HAROOF ART COLLECTIVE. ALL RIGHTS RESERVED. — CRAFTED BY FAISAL
        </div>
        
        <div className="flex flex-col sm:flex-row gap-6">
          <button 
            // @ts-ignore
            onClick={() => window.open(`https://wa.me/${config?.whatsappNumber || (import.meta as any).env.VITE_WHATSAPP_NUMBER}`, "_blank")}
